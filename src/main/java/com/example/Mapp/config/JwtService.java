...
public class JwtService {
    ...
    private static final int EXPIRES_IN = 900000; //900000
    private static final long REFRESH_EXPIRES_IN = 24L*7*60*60*1000; //24L*30*60*60*1000
    ...
    public String generateRefreshToken(Map<String, Object> extraClaims, UserDetails userDetails){
        return Jwts.builder()
                ...
                .setSubject(userDetails.getUsername())
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + EXPIRES_IN + REFRESH_EXPIRES_IN))
                .signWith(getSignInKey(), SignatureAlgorithm.HS256)
                .compact();
    }
